...
OptionBox::OptionBox(Renderer* pRenderer, unsigned int GUIFont, unsigned int OutlineGUIFont, const std::string &label, const Colour& fontColour, const Colour& outlineColour)
  : AbstractButton(pRenderer, GUIFont, label),
	m_pToggledIcon(0),
	m_pToggledSelectedIcon(0),
	m_pToggledHoverIcon(0),
...
void OptionBox::SetLabelColour(const Colour& color)
{
	m_label.SetColour(color);
}

void OptionBox::SetNormalLabelColour(const Colour& normal)
{
...
void OptionBox::SetHoverLabelColour(const Colour& hover)
{
...
void OptionBox::SetPressedLabelColour(const Colour& pressed)
{
