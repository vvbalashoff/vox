...
int Frustum::PointInFrustum(const vec3 &point) const
{
...
int Frustum::SphereInFrustum(const vec3 &point, float radius) const
{
	int result = FRUSTUM_INSIDE;
	float distance;
...
int Frustum::CubeInFrustum(const vec3 &center, float x, float y, float z) const
{
	int result = FRUSTUM_INSIDE;
