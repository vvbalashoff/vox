...
const Matrix4x4& VoxelObject::GetModelMatrix(int qubicleMatrixIndex) const
{
...
vec3 VoxelObject::GetCenter() const
{
	if(m_pVoxelModel == nullptr || m_loaded == false)
	{
...
void VoxelObject::Render(bool renderOutline, bool reflection, bool silhouette, const Colour& OutlineColour)
{
	if(m_pVoxelModel != nullptr)
	{
