...
const BoundingBox& MS3DAnimator::GetBoundingBox() const
{
...
const Matrix4x4& MS3DAnimator::GetBoneMatrix(int index) const
{
	const Matrix4x4& final = pJointAnimations[index].final;
	return final;
}
