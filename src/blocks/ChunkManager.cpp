...
void ChunkManager::GetGridFromPosition(const vec3& position, int* gridX, int* gridY, int* gridZ)
{
...
bool ChunkManager::FindClosestFloor(const vec3& position, vec3* floorPosition)
{
