...
public:
	...
	// Inside chunk
	bool IsInsideChunk(const vec3& pos) const;
	...
	void CreateMesh();
	void CompleteMesh();
	void UpdateMergedSide(int *merged, int blockx, int blocky, int blockz, int width, int height, vec3 *p1, vec3 *p2, vec3 *p3, vec3 *p4, int startX, int startY, int maxX, int maxY, bool positive, bool zFace, bool xFace, bool yFace) const;
