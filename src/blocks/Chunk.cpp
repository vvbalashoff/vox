...
// Position
void Chunk::SetPosition(const vec3& pos)
{
	m_position = pos;
}
...
// Neighbours
int Chunk::GetNumNeighbours() const
{
...
// Inside chunk
bool Chunk::IsInsideChunk(const vec3& pos) const
{
...
void Chunk::GetColour(int x, int y, int z, float* r, float* g, float* b, float* a) const
{
...
void Chunk::UpdateMergedSide(int *merged, int blockx, int blocky, int blockz, int width, int height, vec3 *p1, vec3 *p2, vec3 *p3, vec3 *p4, int startX, int startY, int maxX, int maxY, bool positive, bool zFace, bool xFace, bool yFace) const
{
	bool doMore = true;
